                    ...
                    <form>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div>
                                ...
                                <input type="text" class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition" placeholder="Adınız Soyadınız">
                            </div>
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-2">Telefon Numarası</label>
                                <input type="tel" class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition" placeholder="05XX XXX XX XX">
                            </div>
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-2">E-Posta Adresi</label>
                                <input type="email" class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition" placeholder="ornek@email.com">
                            </div>
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-2">İl / İlçe</label>
                                <input type="text" class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition" placeholder="Örn: Mersin / Yenişehir">
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <label class="cursor-pointer">
                                    <input type="radio" name="service" class="service-radio hidden">
                                ...
                                <label class="cursor-pointer">
                                    ...
                                    <div class="border-2 border-gray-200 rounded-xl p-4 text-center hover:border-blue-400 transition h-full flex flex-col items-center justify-center gap-2">
                                        ...
                                        <span class="font-semibold text-sm">Kombi / Isıtma</span>
                                    </div>
                                </label>
                                <label class="cursor-pointer">
                                    <input type="radio" name="service" class="service-radio hidden">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <select class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 focus:border-blue-500 outline-none">
                            ...
                            <div>
                                ...
                                <input type="number" class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 focus:border-blue-500 outline-none" placeholder="Örn: 120">
                            </div>
                        </div>

                        <div class="mb-8">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Eklemek İstedikleriniz / Notunuz</label>
                            <textarea rows="4" class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 focus:border-blue-500 outline-none" placeholder="Varsa marka tercihi, özel durumlar veya keşif için uygun olduğunuz saatler..."></textarea>
                        </div>
